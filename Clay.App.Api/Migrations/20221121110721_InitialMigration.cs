    ...
    public partial class InitialMigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    DoorTypeId = table.Column<int>(nullable: false)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TypeDoorTypeId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Door", x => x.DoorId);
                    table.ForeignKey(
                        name: "FK_Door_DoorType_TypeDoorTypeId",
                        column: x => x.TypeDoorTypeId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Door_TypeDoorTypeId",
                table: "Door",
                column: "TypeDoorTypeId");
        }
